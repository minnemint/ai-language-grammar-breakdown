"use client"
import { CameraControls, Environment, Float, Gltf, Html,} from "@react-three/drei"
...
export const Experience = () => {
    ...
    return(
        ...
        <Canvas camera={{
            ...
            />
            <Gltf src={`/models/classroom_${classroom}.glb`} 
